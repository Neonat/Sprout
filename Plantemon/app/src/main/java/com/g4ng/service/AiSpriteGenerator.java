...
public class AiSpriteGenerator {
    ...
    // Swap out PROMPT to test different styles
    private static final String PROMPT =
            "pixel art pokemon-style plant sprite, front-facing, pure white background, " +
            "bold black outlines, vibrant saturated colors, cute chibi style, " +
            "single plant subject, game sprite, no text, no shadow";

    // Returns byte[] of the generated PNG
    public Object generateSprite(Object photo) throws Exception {
